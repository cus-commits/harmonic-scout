...
function CompanyCard({ company, onFavorite, isSaved }) {
  ...
  return (
    <div className="rounded-[14px] border border-border/[0.06] hover:border-accent/18 p-3.5 space-y-2.5 transition-all" style={{ background: 'rgba(46, 42, 37, 0.55)' }}>
      ...
      <div className="flex items-center gap-1.5 flex-wrap"><FindSimilar addFavorite={addFavorite} isFavorited={isFavorited} companyName={company.name} companyId={company.id} /><CrmButton company={company} /><RemoveMenu company={company} /></div>
    </div>
  );
}
  ...
  return (
    <div className="flex flex-col h-[100dvh] max-w-5xl mx-auto">
      ...
      <div className="px-4 pt-4 pb-2 flex-shrink-0">
        <h1 className="font-serif text-lg font-semibold text-bright">Pigeon Finder</h1>
        <p className="font-mono text-[10px] text-muted">AI deal analyst • 30M+ companies • Daxos Capital</p>
        <div className="mt-2">
